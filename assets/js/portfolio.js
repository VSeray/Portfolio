...
{
  name: 'Metrics Webapp',
  details: ['Stock Webapp', 'Full Stack Dev','2022'],
  smallDescription: 'Metrics Webapp is a web(mobile-focused) app for checking the companies listed on the stock exchange and see their live metrics. Its data is consumed from the Financial modelling API. It is built using React, Redux, and Styled Components, Framer Motion, Recharts.',
  bigDescription: "This app displays a list of popular stock market prices. Users can click on selected categories including forex, majors, cryptocurrencies, stocks, and ETFs. Each category lists the latest prices update for the pair. Consumes the Financial Modeling Prep API.",
  imageUrlMobile: 'assets/images/Metrics.PNG',
  imageUrlDesktop: 'assets/images/Metrics.PNG',
  technologiesPopup: ['html', 'React / Redux', 'CSS', 'JavaScript'],
  technologies: ['html', 'React / Redux', 'CSS', 'JavaScript'],
  popupImageUrlMobile: 'assets/images/Metrics_mobile.PNG',
  popupImageUrlDesktop: 'assets/images/Metrics_mobile.PNG',
  linkLive: 'https://vseray-metrics-webapp.netlify.app/',
  linkSource: 'https://github.com/VSeray/Metrics-Webapp.git',
}];
